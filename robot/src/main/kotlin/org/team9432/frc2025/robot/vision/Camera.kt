...
class Camera(
    ...
    override fun periodic() {
        ...
        //            // Add tag poses
        //            tagPoses.addAll(
        //                observation.trackedTags.tags.mapNotNull { tagId ->
        // aprilTagLayout.getTagPose(tagId).getOrNull() }
        //            )
        //
        //            // Check whether to reject pose
        //            val faults = observation.getFaults()
        //
        //            // For now, reject the pose if any faults are detected. In the future we may
        // just
        ...
        //            val stdDevFactor = observation.avgDistance.pow(2.0) /
        // observation.trackedTags.tags.size
