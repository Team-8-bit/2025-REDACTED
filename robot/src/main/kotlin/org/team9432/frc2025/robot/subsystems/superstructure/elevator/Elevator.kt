...
class Elevator(private val io: ElevatorIO) : SubsystemBase() {
    ...
    enum class Goal(private val setpointSupplier: () -> Double) {
        ...
        SCORE_L1(LoggedTunableNumber("Elevator/Setpoints/L1", 0.2)),
        SCORE_L2(LoggedTunableNumber("Elevator/Setpoints/L2", 0.54)),
        SCORE_L3(LoggedTunableNumber("Elevator/Setpoints/L3", 0.97)),
        SCORE_L4(LoggedTunableNumber("Elevator/Setpoints/L4", ElevatorConstants.MAX_POSITION)),
        PREP_L4(LoggedTunableNumber("Elevator/Setpoints/L4Prep", 0.625)),
